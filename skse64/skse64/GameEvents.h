...
{
public:
	DEF_MEMBER_FN(AddEventSink_Internal, void, 0x0056B570, void * eventSink);
	// ??_7BGSProcedureShoutExecState@@6B@ dtor | +43
	DEF_MEMBER_FN(RemoveEventSink_Internal, void, 0x00423DD0, void * eventSink);
	// D6BA7CEC95B2C2B9C593A9AEE7F0ADFFB2C10E11+456
	DEF_MEMBER_FN(SendEvent_Internal, void, 0x00177F40, void * evn);
};
...
class EventDispatcher : public BaseEventDispatcher
{
	...
	//DEFINE_MEMBER_FN(AddEventSink_Internal, void, 0x0056B570, SinkT * eventSink);
	//// ??_7BGSProcedureShoutExecState@@6B@ dtor | +43
	//DEFINE_MEMBER_FN(RemoveEventSink_Internal, void, 0x00423DD0, SinkT * eventSink);
	//// D6BA7CEC95B2C2B9C593A9AEE7F0ADFFB2C10E11+456
...
public:
	...
	void SendEvent(EventArgT * evn)				{ SendEvent_Internal(evn); }
};

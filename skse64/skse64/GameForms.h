...
public:
	...
	bool Is(FormType type) { return formType == type; }
	...
	bool IsDisabled() { return (flags & kFlagIsDisabled) != 0; };
	bool IsDeleted() { return (flags & kFlagIsDeleted) != 0; }
};
...
public:
	...
	DEFINE_MEMBER_FN(AddFormToList, void, 0x002C5550, TESForm * form);
	DEFINE_MEMBER_FN(RemoveFormFromList, void, 0x002C56F0, TESForm * form);
	DEFINE_MEMBER_FN(RevertList, void, 0x002C5480);
...
public:
	...
	DEFINE_MEMBER_FN(ForceRefTo, UInt32, 0x003751D0, UInt32 aliasId, TESObjectREFR * reference);
	DEFINE_MEMBER_FN(NewGame_Internal, UInt8, 0x00370A90, UInt8 * unk1, UInt8 unk2);
...
public:
	...
	DEFINE_MEMBER_FN(GetNorthRotation, double, 0x0026D690);
};
...
//	void		** _vtbl;	// 00
	...
	static IFormFactory *	GetFactoryForType(UInt32 type)
	{
		...
		static RelocPtr<IFormFactory *> kFactoryList(0x01EE9C60);
